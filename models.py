...
class ChatSession:
    ...
    def to_dict(self) -> Dict[str, Any]:
        return {
            ...
            'previous_summaries': [summary.to_dict() for summary in self.previous_summaries]
        }
    ...
    def from_dict(cls, data: Dict[str, Any]) -> 'ChatSession':
        return cls(
            ...
            previous_summaries=[SessionSummary.from_dict(summary) for summary in data['previous_summaries']]
        )

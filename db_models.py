...
from pytidb.datatype import TEXT, JSON, DATETIME, BOOLEAN, INT
...
class TiDBConnection:
    ...
    def __init__(self):
        if self._db is None:
            ...
            self.sessions_table = self._db.create_table(schema=ChatSessionDB, if_exists="overwrite")
            self.summaries_table = self._db.create_table(schema=SessionSummaryDB, if_exists="overwrite")
